...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		$(function()
		{
			...
			{
				window.document.location.href = "userManager.jsp?username=<%= request.getParameter("username") %>";
			})
		})
  ...
  <body id="body">
	...
	<form action="userUploadAction.action" method="post" enctype="multipart/form-data">
